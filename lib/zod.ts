...
export const UploadSchema = z.object({
    title: z.string().min(1, "Book Title is required").max(100, "Book Title is too long"),
    author: z.string().min(1, "Book Author is required").max(100, "Book Author is too long"),
